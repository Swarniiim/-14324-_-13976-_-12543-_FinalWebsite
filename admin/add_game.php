...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $stmt = $conn->prepare("INSERT INTO games (title, genre, platform, image, category,description,trailer_url) VALUES (?, ?, ?, ?, ?, ?,?)");
$stmt->bind_param("sssssss", $title, $genre, $platforms, $imageName, $category, $description, $trailer);
